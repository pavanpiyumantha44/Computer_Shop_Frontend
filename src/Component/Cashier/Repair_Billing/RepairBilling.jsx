...
import { Form,Table,Card,Badge,Modal,Button,Pagination } from 'react-bootstrap';
...
const filteredData = repairs.filter((value) =>
value.cusName.toLowerCase().includes(searchTerm.toLowerCase())
);
...
const curretnRepair = filteredData.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <>
      <div className="container" style={{ height: "90vh" }}>
              ...
              <div className="shadow py-4">
                <div className="row">
                  ...
                  <div className="col-4">
                    ...
                    <h5 className="text-success fw-bold">
                      {completedRepairs[0].service_charge} /=
                    </h5>
                    <h5 className="text-danger fw-bold">
                      {completedRepairs[0].repair_details}
                    </h5>
                  </div>
                ...
                <div className="row my-4">
                  ...
                  <div className="col-8">
                    ...
                    <h5 className="text-success fw-bold text-center my-4 text-decoration-underline">
                    ...
                    <div className="col-4">
                      <Form>
                        <Form.Control
                          ...
                          onChange={(e) => setUserPaidAmount(e.target.value)}
                        ></Form.Control>
                      </Form>
                    </div>
                    <div className="col-3">
                      <Button className="btn btn-success" onClick={handleBill}>
                        Generate Invoice
                      </Button>
                    </div>
                  </div>
        ...
        >
          ...
          <Modal.Body>
            <button
              className="btn btn-success d-flex ms-auto mx-4"
              onClick={handleInvoice}
            >
              Save Data
            </button>
            <RepairBillPDF
              billData={completedRepairs}
              totalPrice={totalAmount}
              userPaid={userPaidAmount}
              Balance={balance}
            />
          </Modal.Body>
        </Modal>
                ...
                {curretnRepair.map((value, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        {value.receive_date.replace("T", " - ").substr(0, 21)}
                      </td>
                      <td>
                        <Button
                          variant="success"
                          title="bill"
                          onClick={() => handleCompletedRepairs(value.repID)}
                        >
                          <FaFileInvoiceDollar />
                        </Button>
                      </td>
